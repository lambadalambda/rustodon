...
pub use oauth::{
    ...
    WRITE_ACCOUNTS, WRITE_BLOCKS, WRITE_BOOKMARKS, WRITE_CONVERSATIONS, WRITE_FAVOURITES,
    WRITE_FOLLOWS, WRITE_MEDIA, WRITE_MUTES, WRITE_NOTIFICATIONS, WRITE_REPORTS, WRITE_STATUSES,
};
pub use records::*;
